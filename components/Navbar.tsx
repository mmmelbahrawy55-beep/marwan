      ...
      <div className="container flex items-center justify-between h-16 md:h-[72px]">
        ...
        <div className="hidden md:flex items-center gap-2">
          <a
            href="/cv"
            target="_blank"
            className="inline-flex items-center gap-2 px-4 py-2 text-[13px] font-medium text-[#6366f1] border border-[#6366f1]/20 rounded-xl hover:bg-[#6366f1]/[0.06] transition-all duration-200"
          >
          ...
          <a
            href="#contact"
            className="inline-flex items-center gap-2 px-5 py-2 text-[13px] font-semibold text-white bg-[#6366f1] rounded-xl hover:bg-[#4f46e5] transition-all duration-200 hover:shadow-[0_0_20px_rgba(99,102,241,0.25)]"
          >
            Let&apos;s Talk
          </a>
        </div>
